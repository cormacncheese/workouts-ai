        ...
        <div className="pt-16 md:pt-32">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">
              Zenbase reads all your files, links and connections to summarize
              content and unlock new insights
            </p>
          </div>
                        ...
                        <div className="mb-5">
                          <div>
                            ...
                            <p className="text-slate-400">
                              Generate responses to blogs, emails, social media
                              posts and more using your brand voice
                            </p>
                          </div>
                        </div>
                        {/* <div>
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">
                            Zenbase never takes a break and is connected to your
                            Google Drive, Notion, your website, calendar and
                            more to alert you of any relevant updates.
                          </p>
                        </div>
                      </div>
                      {/* Image */}
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">
                            Zenbase trains on your data to provid the best
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Personal</h4>
              </div>
              <p className="text-sm text-slate-400">
                Your Zenbase account is personal to you and your data.
              </p>
            </div>
            {/* Feature */}
            <div>
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">
                Magically learns your style of work and you want things to
                sound.
              </p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">24/7</h4>
              </div>
              <p className="text-sm text-slate-400">
                Works behind the scenes so you are always being productive, even
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">History</h4>
              </div>
              <p className="text-sm text-slate-400">
                Remebers all converstions and interactions so you can always go
                back and review.
              </p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Private</h4>
              </div>
              <p className="text-sm text-slate-400">
