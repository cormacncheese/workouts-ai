  ...
  const items: Item[] = [
    {
      ...
      quote: 'Analyzing all my startup data has never been quicker.',
      name: 'Cole',
      role: 'CEO'
    },
    {
      ...
      quote:
        'I have been using this for a few weeks to analyze our product data and I absolutely love it!',
      name: 'Ami',
    ...
    },
    {
      ...
      quote:
        'It is like Superhuman but for all your apps. Helps me keep track of everything.',
      name: 'Ryan',
      role: 'Agency Owner'
    }
  ];
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center -m-1.5">
              {items.map((item, index) => (
                ...
                >
                  <span className="relative px-2 rounded-md">
