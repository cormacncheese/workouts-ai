            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              >
                ...
                <p className="text-lg text-slate-400 mb-8">
                  Chat with your files, apps, websites, and more. Ask questions,
                  get insights and monitor your projects in real-time.
                </p>
              </div>
                ...
                <div className="relative py-24 -mt-12">
                  ...
                  <div className="flex items-center justify-center">
                    <div className="relative w-full h-full flex justify-center items-center">
                      ...
                      <Image
                        src="https://dcsladfmohmhomyxvhzz.supabase.co/storage/v1/object/public/general/website/features/features-train.png"
                        width={1200}
                        height={800}
