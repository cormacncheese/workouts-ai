      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            <h2 className="h2 text-4xl bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">
              Built for Top Performers
            </h2>
            <p className="text-md text-slate-400">
              Zenbase is your AI assistant designed specifically for busy
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Analyze data</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Drag all your analytics and metrics into Zenbase and ask
                    anything to uncover insights.
                  </p>
                </div>
                {/* Feature */}
                <div>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Build a brand</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Train Zenbase on your voice, personality and preferences to
                    build an AI unique to you.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="py-8">
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Connect Zenbase to your client list and the internet to
                    discover patterns and new leads
                  </p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Optimize SEO</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Connect your customer links and analyze their website in
                    real-time.
                  </p>
                </div>
                {/* Feature */}
            ...
            <div className="py-8">
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Zenbase knows your business and can train your employees to
                    onboard.
                  </p>
                </div>
                {/* Feature */}
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Let Zenbase collect your current brand stats, docs and
                    content to develop future business strategies
                  </p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">24/7 Support</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Zenbase works around the clock to analyze and optimize your
                    work and business.
                  </p>
                </div>
              </div>
