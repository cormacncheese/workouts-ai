...
import FeatureTab from '@/components/sections/features-01/components/feature-tab';
    ...
    <section id="features" className="overflow-hidden">
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div
          ...
          aria-hidden="true"
        >
          <div className="absolute left-1/2 -translate-x-1/2 top-0 -z-10 opacity-20">
            <Image
              src={Illustration}
            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              >
                ...
                {/* <h3 className="h3 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-3">
                  Personalized exaclty how you like it.
                </h3> */}
                <p className="text-lg text-slate-400 mb-8">
                  Upload PDF and documents, connect your websites and integrate
                  your favorite apps into one place to monitor and get insights.
                </p>
                <div className="mt-8 max-w-xs max-md:mx-auto space-y-2">
                  <FeatureTab
                    ...
                    label="Upload PDFs, CSVs, DOCs, etc"
                    tab={tab}
                    tabIndex={1}
                    setTab={setTab}
                  />
                  ...
                  <FeatureTab
                    ...
                    label="Connect websites and links"
                    tab={tab}
                    tabIndex={2}
                    setTab={setTab}
                  />
                  ...
                  <FeatureTab
                    ...
                    label="Integrate your data sources"
                    tab={tab}
                    tabIndex={3}
                    setTab={setTab}
                  />
                ...
                <div className="relative py-24 -mt-12">
                  ...
                  <div className="flex items-center justify-center">
                    <div className="relative w-full h-full flex justify-center items-center">
                      ...
                      <Image
                        src="https://dcsladfmohmhomyxvhzz.supabase.co/storage/v1/object/public/general/website/features/connections-feature.png"
                        width={1200}
                        height={800}
